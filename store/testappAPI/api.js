...
const testappAPI = axios.create({
  baseURL: "https://taskapp-48450.botics.co",
...
function modules_files_uploads_list(payload) {
  return testappAPI.get(`/modules/files/uploads/`)
}
function modules_files_uploads_create(payload) {
  return testappAPI.post(`/modules/files/uploads/`, payload)
}
function modules_files_uploads_retrieve(payload) {
  return testappAPI.get(`/modules/files/uploads/${payload.id}/`)
}
function modules_files_uploads_update(payload) {
  return testappAPI.put(`/modules/files/uploads/${payload.id}/`, payload)
}
function modules_files_uploads_partial_update(payload) {
  return testappAPI.patch(`/modules/files/uploads/${payload.id}/`, payload)
}
function modules_files_uploads_destroy(payload) {
  return testappAPI.delete(`/modules/files/uploads/${payload.id}/`)
}
