"""
Django settings for testapp_48450 project.
...
ROOT_URLCONF = 'testapp_48450.urls'
...
WSGI_APPLICATION = 'testapp_48450.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testapp_48450 API",
    "DESCRIPTION": "API documentation for testapp_48450 App",
    "VERSION": "v1",
}
